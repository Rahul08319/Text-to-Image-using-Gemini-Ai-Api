...
# Try to import Gemini API, handle gracefully if not available
try:
...
def generate_image():
    try:
        ...
        if not GENAI_AVAILABLE:
            return jsonify({
                'error': 'Gemini AI library is not available in this deployment environment. Please run locally with proper dependencies.'
            }), 500
